...
class BYOMBatchBuiltinStack(core.Stack):
    def __init__(self, scope: core.Construct, id: str, **kwargs) -> None:
        ...
        batch_nobuild_pipeline.add_to_role_policy(iam.PolicyStatement(
        ...
        core.CfnOutput(self, id="Pipelines", value=f'https://console.aws.amazon.com/codesuite/codepipeline/pipelines/{batch_nobuild_pipeline.pipeline_name}/view?region={core.Aws.REGION}')
