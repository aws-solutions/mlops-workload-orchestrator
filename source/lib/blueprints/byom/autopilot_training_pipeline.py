...
class AutopilotJobStack(core.Stack):
    def __init__(self, scope: core.Construct, id: str, **kwargs) -> None:
        ...
        self.generate_candidate_definitions_only = pf.create_generate_definitions_only_parameter(self)
        ...
        invoke_lambda_custom_resource = self._create_invoke_lambda_custom_resource(
            function_name=autopilot_lambda.function_name, function_arn=autopilot_lambda.function_arn
        )
    ...
    def _create_autoplot_lambda(self):
        ...
        autopilot_lambda = autopilot_training_job(
            ...
            problem_type=core.Fn.condition_if(
                self.problem_type_provided.logical_id, self.problem_type.value_as_string, core.Aws.NO_VALUE
            ).to_string(),
            job_objective=core.Fn.condition_if(
                self.job_objective_provided.logical_id, self.job_objective.value_as_string, core.Aws.NO_VALUE
            ).to_string(),
