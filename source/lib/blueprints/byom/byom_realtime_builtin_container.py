...
class BYOMRealtimeBuiltinStack(core.Stack):
    def __init__(self, scope: core.Construct, id: str, **kwargs) -> None:
        ...
        custom_container = core.CfnParameter(
            ...
            type="String",
            description=(
                "Should point to path to a zip file containing dockerfile and assets for building "
                "a custom model. If empty it will beusing containers from SageMaker Registry"
            ),
        )
        ...
        # source stage
        source_output, source_action_definition = source_action(model_artifact_location, assets_bucket)
        ...
        realtime_nobuild_pipeline.add_to_role_policy(
            iam.PolicyStatement(
        ...
        realtime_nobuild_pipeline.add_to_role_policy(invoke_lambdas_policy)
        ...
        core.CfnOutput(
            ...
            value=(
                ...
                f"{realtime_nobuild_pipeline.pipeline_name}/view?region={core.Aws.REGION}"
            ),
        )
        core.CfnOutput(
            self,
