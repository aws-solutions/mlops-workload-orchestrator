...
class BYOMBatchBuildStack(core.Stack):
    def __init__(self, scope: core.Construct, id: str, **kwargs) -> None:
        ...
        assets_bucket = s3.Bucket(
            ...
            server_access_logs_prefix="BYOMBatchBuildStack",
        ...
        batch_build_pipeline.add_to_role_policy(iam.PolicyStatement(
        ...
        core.CfnOutput(self, id="Pipelines", value=f'https://console.aws.amazon.com/codesuite/codepipeline/pipelines/{batch_build_pipeline.pipeline_name}/view?region={core.Aws.REGION}')
