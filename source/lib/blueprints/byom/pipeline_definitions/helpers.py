    ...
    return {
        "cfn_nag": {
            "rules_to_suppress": [
                ...
                {
                    "id": "W51",
                    "reason": "This bucket does not need bucket policy. Permissions write to this bucket are set with IAM",
                },
            ]
        }
    }
    ...
    return {
        "cfn_nag": {
            "rules_to_suppress": [
                ...
                {
                    "id": "W35",
                    "reason": "This bucket is auto generated by CDK's codepipeline construct to handle its assets. It does not need access logging",
                },
            ]
        }
    }
