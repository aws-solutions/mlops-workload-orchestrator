...
class BYOMRealtimeBuildStack(core.Stack):
    def __init__(self, scope: core.Construct, id: str, **kwargs) -> None:
        ...
        custom_container = core.CfnParameter(
            ...
            "CUSTOM_CONTAINER",
            type="String",
            description="Should point to a zip file containing dockerfile and assets for building a custom model. If empty it will beusing containers from SageMaker Registry",
        )
        ...
        assets_bucket = s3.Bucket(
            ...
            server_access_logs_prefix="BYOMRealtimeBuildStack",
        ...
        realtime_build_pipeline.add_to_role_policy(iam.PolicyStatement(
        ...
        core.CfnOutput(self, id="Pipelines", value=f'https://console.aws.amazon.com/codesuite/codepipeline/pipelines/{realtime_build_pipeline.pipeline_name}/view?region={core.Aws.REGION}')
